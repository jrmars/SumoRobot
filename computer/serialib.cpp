...
unsigned long int TimeOut::ElapsedTime_ms()
{
	...
	// Get current time
	//sec = stNew.wSecond - stOld.wSecond;
	//usec = stNew.wMilliseconds - stOld.wMilliseconds;
	msec = Current - Start;
	//if (msec < 0) {                                                       // If the previous millisec is higher than the current one
		//msec = 1000 - Current - Start;          // Recompute the milliseonds
